  ...
  return (
    <section id="contact" className="py-20">
      <div className="mx-auto max-w-7xl px-6 sm:px-8">
        <div className="rounded-2xl bg-gray-900 text-white p-10 ring-1 ring-black/5 overflow-hidden relative">
          ...
          <div className="max-w-2xl space-y-4">
            ...
            <form onSubmit={(e)=>e.preventDefault()} className="mt-6 grid sm:grid-cols-2 gap-3">
              ...
              <button className="inline-flex items-center justify-center rounded-md bg-white text-gray-900 px-5 py-2 font-medium hover:bg-gray-100 transition-colors sm:w-auto">Request details</button>
            </form>
